...
class XmlDirectoryEmployeeEmployeesEmployeeInnerFieldInner(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Field identifier on the `<field>` element.")
    value: Optional[StrictStr] = Field(default=None, description="Field value serialized as the `<field>` element text content.")
