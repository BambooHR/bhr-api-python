...
class XmlDirectoryEmployeeEmployeesEmployeeInnerFieldInner(BaseModel):
    """
    ...
    id: StrictStr | None = Field(
        default=None,
        description="Field identifier (XML attribute). Array of employee records. Each employee object contains dynamic field values based on the fields defined in the 'fields' array. Common fields include: id, displayName, firstName, lastName, preferredName, jobTitle, workPhone, mobilePhone, workEmail, department, location, division, twitterFeed, pronouns, workPhoneExtension, photoUploaded, photoUrl, canUploadPhoto. Actual fields may vary by company configuration.",
    )
    value: StrictStr | None = Field(default=None, description="Field value (element text content)")
