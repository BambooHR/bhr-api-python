...
class GetBreakPolicySuggestionsRequest(BaseModel):
    """
    GetBreakPolicySuggestionsRequest
    """

    prompt: Annotated[str, Field(min_length=1, strict=True)] = Field(
        description='The user\'s request or question for break policy suggestions (e.g. "What policies do we need for our California employees?")'
    )
