...
class LoginFailureXmlResponse(BaseModel):
    """
    LoginFailureXmlResponse
    """

    response: StrictStr | None = Field(default=None, description="Always `declined`.")
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({"response": obj.get("response")})
        return _obj
