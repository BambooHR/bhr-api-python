...
class DataRequest(BaseModel):
    ...
    aggregations: DataRequestAggregations | None = None
    sort_by: list[DataRequestSortByInner] | None = Field(
        default=None,
        description="Ordered list of sort rules. Priority follows array order. Include aggregationType when sorting by an aggregated value in a grouped request; it must match an aggregation requested for the same field.",
        alias="sortBy",
    )
    filters: DataRequestFilters | None = None
    group_by: list[StrictStr] | None = Field(
        default=None,
    ...
    show_history: list[StrictStr] | None = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "aggregations": DataRequestAggregations.from_dict(obj["aggregations"])
