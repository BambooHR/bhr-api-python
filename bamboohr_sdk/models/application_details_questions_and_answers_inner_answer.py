...
class ApplicationDetailsQuestionsAndAnswersInnerAnswer(BaseModel):
    """
    ApplicationDetailsQuestionsAndAnswersInnerAnswer
    """

    id: StrictInt | None = Field(default=None, description="Answer ID")
    label: StrictStr | None = Field(default=None, description="Answer text")
