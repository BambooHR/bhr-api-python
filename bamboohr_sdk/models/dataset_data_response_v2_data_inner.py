...
class DatasetDataResponseV2DataInner(BaseModel):
    """
    DatasetDataResponseV2DataInner
    """

    fields: dict[str, DatasetDataResponseV2DataInnerFieldsValue | None] | None = None
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "fields": dict(
                    (_k, DatasetDataResponseV2DataInnerFieldsValue.from_dict(_v)) for _k, _v in obj["fields"].items()
                )
