...
class WebhookBadRequestErrorsInner(BaseModel):
    """
    ...
    __properties: ClassVar[list[str]] = ["error", "issues"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({"error": obj.get("error"), "issues": obj.get("issues")})
        return _obj
