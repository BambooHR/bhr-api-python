...
class TimeTrackingOffsetPaginatedResponseDataV1Meta(BaseModel):
    """
    Pagination metadata
    """
    ...
    offset: StrictInt
    limit: StrictInt
    __properties: ClassVar[list[str]] = ["totalItems", "offset", "limit"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {"totalItems": obj.get("totalItems"), "offset": obj.get("offset"), "limit": obj.get("limit")}
        )
        return _obj
