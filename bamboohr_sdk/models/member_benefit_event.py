...
class MemberBenefitEvent(BaseModel):
    ...
    members: list[MemberBenefitEventMembersInner] | None = Field(default=None, description="Members")
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "members": [MemberBenefitEventMembersInner.from_dict(_item) for _item in obj["members"]]
