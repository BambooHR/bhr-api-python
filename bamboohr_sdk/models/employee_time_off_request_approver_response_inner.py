...
class EmployeeTimeOffRequestApproverResponseInner(BaseModel):
    """
    EmployeeTimeOffRequestApproverResponseInner
    """

    user_id: StrictInt = Field(description="User ID of the approver", alias="userId")
    display_name: StrictStr = Field(description="Display name of the approver", alias="displayName")
    employee_id: StrictInt = Field(description="Employee ID of the approver", alias="employeeId")
    photo_url: StrictStr | None = Field(default=None, alias="photoUrl")
    __properties: ClassVar[list[str]] = ["userId", "displayName", "employeeId", "photoUrl"]
