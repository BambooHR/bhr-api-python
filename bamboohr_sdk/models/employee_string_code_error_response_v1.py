...
class EmployeeStringCodeErrorResponseV1(BaseModel):
    """
    Error response returned by Employee API endpoints where `error.code` is a string identifier.
    """

    error: EmployeeStringCodeErrorResponseV1Error
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "error": EmployeeStringCodeErrorResponseV1Error.from_dict(obj["error"])
