...
EMPLOYEETABLEROWVALUEANYOFINNER_ANY_OF_SCHEMAS = ["Dict[str, object]", "bool", "float", "int", "str"]

class EmployeeTableRowValueAnyOfInner(BaseModel):
    """
    ...
    if TYPE_CHECKING:
        actual_instance: Optional[Union[Dict[str, object], bool, float, int, str]] = None
    else:
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        instance = EmployeeTableRowValueAnyOfInner.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in EmployeeTableRowValueAnyOfInner with anyOf schemas: Dict[str, object], bool, float, int, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into EmployeeTableRowValueAnyOfInner with anyOf schemas: Dict[str, object], bool, float, int, str. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], Dict[str, object], bool, float, int, str]]:
