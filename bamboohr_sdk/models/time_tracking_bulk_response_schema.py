...
class TimeTrackingBulkResponseSchema(BaseModel):
    ...
    success: StrictBool | None = Field(default=None, description="Indicates whether the operation was successful")
    response: TimeTrackingBulkResponseSchemaResponse | None = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "response": TimeTrackingBulkResponseSchemaResponse.from_dict(obj["response"])
