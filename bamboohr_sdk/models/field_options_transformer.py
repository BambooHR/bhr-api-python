...
class FieldOptionsTransformer(BaseModel):
    ...
    id: StrictStr | None = Field(default=None, description="The ID of the field option")
    value: StrictStr | None = Field(default=None, description="The value of the field option")
