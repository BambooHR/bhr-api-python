...
class RequestCustomReportFiltersLastChanged(BaseModel):
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({"value": obj.get("value"), "includeNull": obj.get("includeNull")})
        return _obj
