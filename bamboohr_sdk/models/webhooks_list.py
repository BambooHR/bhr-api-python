...
class WebhooksList(BaseModel):
    ...
    WebhooksList
    """ # noqa: E501
    webhooks: Optional[List[WebhooksListWebhooksInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "webhooks": [WebhooksListWebhooksInner.from_dict(_item) for _item in obj["webhooks"]] if obj.get("webhooks") is not None else None
        })
        return _obj
