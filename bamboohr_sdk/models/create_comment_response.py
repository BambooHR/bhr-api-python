...
class CreateCommentResponse(BaseModel):
    ...
    type: StrictStr | None = Field(default=None, description="The type of comment created, e.g. 'comment'")
    id: StrictInt | None = Field(default=None, description="The ID of the newly created comment")
