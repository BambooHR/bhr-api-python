...
class JsonEmployeeFiles(BaseModel):
    ...
    employee: JsonEmployeeFilesEmployee | None = None
    categories: list[JsonEmployeeFilesCategoriesInner] | None = None
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "employee": JsonEmployeeFilesEmployee.from_dict(obj["employee"])
                if obj.get("employee") is not None
                else None,
                "categories": [JsonEmployeeFilesCategoriesInner.from_dict(_item) for _item in obj["categories"]]
