...
class EmployeesDirectoryXmlResponse(BaseModel):
    """
    EmployeesDirectoryXmlResponse
    """

    fieldset: EmployeesDirectoryXmlResponseFieldset | None = None
    employees: EmployeesDirectoryXmlResponseEmployees | None = None
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "fieldset": EmployeesDirectoryXmlResponseFieldset.from_dict(obj["fieldset"])
                if obj.get("fieldset") is not None
                else None,
                "employees": EmployeesDirectoryXmlResponseEmployees.from_dict(obj["employees"])
