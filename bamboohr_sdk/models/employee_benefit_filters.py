...
class EmployeeBenefitFilters(BaseModel):
    """
    EmployeeBenefitFilters
    """ # noqa: E501
    filters: Optional[EmployeeBenefitFiltersFilters]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filters": EmployeeBenefitFiltersFilters.from_dict(obj["filters"]) if obj.get("filters") is not None else None
        })
        return _obj
