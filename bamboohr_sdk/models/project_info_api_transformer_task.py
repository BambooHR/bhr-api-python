...
class ProjectInfoApiTransformerTask(BaseModel):
    """
    Task information
    """

    id: StrictInt | None = Field(default=None, description="Task ID")
    name: StrictStr | None = Field(default=None, description="Task name")
