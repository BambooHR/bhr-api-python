...
class MonitorFieldList(BaseModel):
    """
    MonitorFieldList
    """

    fields: list[MonitorFieldListFieldsInner] = Field(
        description="The list of employee fields available for webhook monitoring."
    )
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "fields": [MonitorFieldListFieldsInner.from_dict(_item) for _item in obj["fields"]]
