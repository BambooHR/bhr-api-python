...
class CompensationBenchmarkDetailEmployeeJobTitle(BaseModel):
    """
    ...
    __properties: ClassVar[list[str]] = ["id", "value", "jobTitle"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({"id": obj.get("id"), "value": obj.get("value"), "jobTitle": obj.get("jobTitle")})
        return _obj
