...
class EmployeeVerificationIntegrationResponse(BaseModel):
    """
    EmployeeVerificationIntegrationResponse
    """

    integration: EmployeeVerificationIntegration
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "integration": EmployeeVerificationIntegration.from_dict(obj["integration"])
