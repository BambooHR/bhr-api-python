...
class ProjectInfoApiTransformerProject(BaseModel):
    """
    Project information
    """

    id: StrictInt | None = Field(default=None, description="Project ID")
    name: StrictStr | None = Field(default=None, description="Project name")
