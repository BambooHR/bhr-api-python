...
class DataRequestFilters(BaseModel):
    ...
    filters: Optional[List[DataRequestFiltersFiltersInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "match": obj.get("match"),
            "filters": [DataRequestFiltersFiltersInner.from_dict(_item) for _item in obj["filters"]] if obj.get("filters") is not None else None
        })
        return _obj
