...
class DatasetsResponseDatasetsInner(BaseModel):
    ...
    name: StrictStr | None = Field(default=None, description="Internal name identifier for the dataset")
    label: StrictStr | None = Field(default=None, description="Human-readable label for the dataset")
