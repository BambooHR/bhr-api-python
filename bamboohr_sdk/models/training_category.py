...
class TrainingCategory(BaseModel):
    ...
    id: StrictInt | None = Field(default=None, description="The ID of the training category.")
    name: StrictStr | None = Field(default=None, description="The name of the training category.")
