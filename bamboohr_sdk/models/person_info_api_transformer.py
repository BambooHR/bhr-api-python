...
class PersonInfoApiTransformer(BaseModel):
    ...
    display_first_name: Optional[StrictStr] = Field(default=None, description="Display first name", alias="displayFirstName")
    last_name: Optional[StrictStr] = Field(default=None, description="Last name", alias="lastName")
    photo_url: Optional[StrictStr] = Field(default=None, description="Photo URL", alias="photoUrl")
