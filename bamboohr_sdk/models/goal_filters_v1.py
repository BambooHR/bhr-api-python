...
class GoalFiltersV1(BaseModel):
    """
    Array containing goal filters and their counts for API v1
    """ # noqa: E501
    filters: Optional[List[GoalFiltersV1FiltersInner]] = Field(default=None, description="Array of goal filter objects with counts")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filters": [GoalFiltersV1FiltersInner.from_dict(_item) for _item in obj["filters"]] if obj.get("filters") is not None else None
        })
        return _obj
