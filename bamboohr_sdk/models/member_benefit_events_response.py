...
class MemberBenefitEventsResponse(BaseModel):
    """
    MemberBenefitEventsResponse
    """ # noqa: E501
    members: Optional[List[MemberBenefitEvent]] = Field(default=None, description="List of member benefit event records, one entry per employee or dependent.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "members": [MemberBenefitEvent.from_dict(_item) for _item in obj["members"]] if obj.get("members") is not None else None
        })
        return _obj
