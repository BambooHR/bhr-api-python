...
class MemberBenefitEventsResponse(BaseModel):
    ...
    members: list[MemberBenefitEvent] | None = Field(
        default=None, description="List of member benefit event records, one entry per employee or dependent."
    )
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "members": [MemberBenefitEvent.from_dict(_item) for _item in obj["members"]]
