...
class AlertTemplateListResponse(BaseModel):
    """
    AlertTemplateListResponse
    """

    alerts: list[AlertTemplateListResponseAlertsInner] | None = None
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "alerts": [AlertTemplateListResponseAlertsInner.from_dict(_item) for _item in obj["alerts"]]
