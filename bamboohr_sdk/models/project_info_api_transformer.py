...
class ProjectInfoApiTransformer(BaseModel):
    ...
    project: ProjectInfoApiTransformerProject | None = None
    task: ProjectInfoApiTransformerTask | None = None
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "project": ProjectInfoApiTransformerProject.from_dict(obj["project"])
