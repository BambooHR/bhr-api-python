...
class ProjectInfoApiTransformer(BaseModel):
    """
    Project information data representation
    """ # noqa: E501
    project: Optional[ProjectInfoApiTransformerProject] = None
    task: Optional[ProjectInfoApiTransformerTask] = None
    __properties: ClassVar[List[str]] = ["project", "task"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "project": ProjectInfoApiTransformerProject.from_dict(obj["project"]) if obj.get("project") is not None else None,
            "task": ProjectInfoApiTransformerTask.from_dict(obj["task"]) if obj.get("task") is not None else None
        })
        return _obj
