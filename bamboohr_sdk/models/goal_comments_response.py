...
class GoalCommentsResponse(BaseModel):
    ...
    comments: list[GoalCommentsResponseCommentsInner] | None = Field(
        default=None, description="Array of comment objects for the goal."
    )
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "comments": [GoalCommentsResponseCommentsInner.from_dict(_item) for _item in obj["comments"]]
