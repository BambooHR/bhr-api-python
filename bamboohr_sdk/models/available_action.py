...
class AvailableAction(BaseModel):
    ...
    """ # noqa: E501
    href: Optional[StrictStr] = Field(default=None, description="The URL for this action")
    fields: Optional[List[Dict[str, Any]]] = Field(default=None, description="Fields that can be modified with this action")
    __properties: ClassVar[List[str]] = ["href", "fields"]
