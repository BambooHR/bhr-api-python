...
class ApplicationsListApplications(BaseModel):
    """
    ApplicationsListApplications
    """

    items: list[ApplicationsListApplicationsItemsInner] | None = Field(
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "items": [ApplicationsListApplicationsItemsInner.from_dict(_item) for _item in obj["items"]]
