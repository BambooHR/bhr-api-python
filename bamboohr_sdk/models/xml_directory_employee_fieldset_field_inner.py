...
class XmlDirectoryEmployeeFieldsetFieldInner(BaseModel):
    ...
    id: StrictStr | None = Field(default=None, description="Field identifier (XML attribute)")
    value: StrictStr | None = Field(default=None, description="Field display name (element text content)")
