...
class ApplicationsListApplicationsInnerJob(BaseModel):
    """
    Information about the job position
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Job position ID")
    title: Optional[ApplicationsListApplicationsInnerJobTitle] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "title": ApplicationsListApplicationsInnerJobTitle.from_dict(obj["title"]) if obj.get("title") is not None else None
        })
        return _obj
