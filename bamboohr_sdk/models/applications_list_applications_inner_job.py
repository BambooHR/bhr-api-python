...
class ApplicationsListApplicationsInnerJob(BaseModel):
    ...
    id: StrictInt | None = Field(default=None, description="Job position ID")
    title: ApplicationsListApplicationsInnerJobTitle | None = None
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "id": obj.get("id"),
                "title": ApplicationsListApplicationsInnerJobTitle.from_dict(obj["title"])
