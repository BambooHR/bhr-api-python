...
class ApplicationDetailsApplicantEducation(BaseModel):
    """
    Applicant's education information
    """ # noqa: E501
    institution: Optional[StrictStr] = Field(default=None, description="Name of the educational institution")
    level: Optional[ApplicationDetailsApplicantEducationLevel] = None
    __properties: ClassVar[List[str]] = ["institution", "level"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "level": ApplicationDetailsApplicantEducationLevel.from_dict(obj["level"]) if obj.get("level") is not None else None
        })
        return _obj
