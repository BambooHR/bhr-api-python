...
EMPLOYEEVALUE_ANY_OF_SCHEMAS = ["List[EmployeeValueAnyOfInner]", "bool", "float", "int", "object", "str"]
...
class EmployeeValue(BaseModel):
    ...
    anyof_schema_5_validator: Optional[List[Optional[EmployeeValueAnyOfInner]]] = None
    # data type: object
    anyof_schema_6_validator: Optional[Dict[str, Any]] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[List[EmployeeValueAnyOfInner], bool, float, int, object, str]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "List[EmployeeValueAnyOfInner]", "bool", "float", "int", "object", "str" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in EmployeeValue with anyOf schemas: List[EmployeeValueAnyOfInner], bool, float, int, object, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into EmployeeValue with anyOf schemas: List[EmployeeValueAnyOfInner], bool, float, int, object, str. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], List[EmployeeValueAnyOfInner], bool, float, int, object, str]]:
