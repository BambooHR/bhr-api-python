...
class TimeTrackingBulkResponseSchemaResponse(BaseModel):
    ...
    id: StrictStr | None = Field(default=None, description="Unique identifier for the time tracking record")
    message: StrictStr | None = Field(default=None, description="Response message, typically used for error details")
