...
class RequestCustomReport(BaseModel):
    ...
    fields: list[StrictStr] | None = Field(
        default=None, description="Array of field IDs to include as columns in the report. Maximum of 400 fields."
    )
    filters: RequestCustomReportFilters | None = None
    filter_duplicates: StrictStr | None = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "filters": RequestCustomReportFilters.from_dict(obj["filters"])
