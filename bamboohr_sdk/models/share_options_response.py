...
class ShareOptionsResponse(BaseModel):
    ...
    persons: list[PersonInfoApiTransformer] | None = Field(
        default=None, description="List of employees with whom goals can be shared."
    )
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "persons": [PersonInfoApiTransformer.from_dict(_item) for _item in obj["persons"]]
