...
class ShareOptionsResponse(BaseModel):
    ...
    """ # noqa: E501
    persons: Optional[List[PersonInfoApiTransformer]] = Field(default=None, description="List of employees with whom goals can be shared.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "persons": [PersonInfoApiTransformer.from_dict(_item) for _item in obj["persons"]] if obj.get("persons") is not None else None
        })
        return _obj
