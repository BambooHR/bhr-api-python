...
class UpdateApplicantStatusResponse(BaseModel):
    ...
    type: StrictStr | None = Field(default=None, description="Always 'positionApplicantStatus'")
    id: StrictInt | None = Field(default=None, description="The ID of the created status change record")
