...
class XmlEmployeeFiles(BaseModel):
    """
    XmlEmployeeFiles
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Employee ID on the root `<employee>` element.")
    category: Optional[List[XmlEmployeeFilesCategoryInner]] = None
    __properties: ClassVar[List[str]] = ["id", "category"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "category": [XmlEmployeeFilesCategoryInner.from_dict(_item) for _item in obj["category"]] if obj.get("category") is not None else None
        })
        return _obj
