...
class XmlEmployeeFiles(BaseModel):
    ...
    id: StrictStr | None = Field(default=None, description="Employee ID on the root `<employee>` element.")
    category: list[XmlEmployeeFilesCategoryInner] | None = None
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "id": obj.get("id"),
                "category": [XmlEmployeeFilesCategoryInner.from_dict(_item) for _item in obj["category"]]
