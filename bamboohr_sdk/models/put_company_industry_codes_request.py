...
class PutCompanyIndustryCodesRequest(BaseModel):
    """
    PutCompanyIndustryCodesRequest
    """

    industry_ids: list[StrictInt | None] = Field(
        description="List of industry IDs associated with the company. Currently limited to a single entry.",
        alias="industryIds",
    )
    __properties: ClassVar[list[str]] = ["industryIds"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({"industryIds": obj.get("industryIds")})
        return _obj
