...
class GoalFiltersV11(BaseModel):
    ...
    filters: list[GoalFiltersV11FiltersInner] | None = Field(
        default=None, description="Array of goal filter objects with counts"
    )
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "filters": [GoalFiltersV11FiltersInner.from_dict(_item) for _item in obj["filters"]]
