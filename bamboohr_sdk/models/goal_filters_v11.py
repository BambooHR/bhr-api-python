...
class GoalFiltersV11(BaseModel):
    """
    Array containing goal filters, their counts, and actions
    """ # noqa: E501
    filters: Optional[List[GoalFiltersV11FiltersInner]] = Field(default=None, description="Array of goal filter objects with counts")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filters": [GoalFiltersV11FiltersInner.from_dict(_item) for _item in obj["filters"]] if obj.get("filters") is not None else None
        })
        return _obj
