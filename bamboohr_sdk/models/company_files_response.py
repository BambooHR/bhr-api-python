...
class CompanyFilesResponse(BaseModel):
    ...
    categories: list[CompanyFilesResponseCategoriesInner] | None = Field(
        default=None, description="List of company file categories."
    )
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "categories": [CompanyFilesResponseCategoriesInner.from_dict(_item) for _item in obj["categories"]]
