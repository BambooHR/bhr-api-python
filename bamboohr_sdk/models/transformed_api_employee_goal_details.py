...
class TransformedApiEmployeeGoalDetails(BaseModel):
    """
    TransformedApiEmployeeGoalDetails
    """ # noqa: E501
    goal: Optional[TransformedApiEmployeeGoalDetailsGoal] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "goal": TransformedApiEmployeeGoalDetailsGoal.from_dict(obj["goal"]) if obj.get("goal") is not None else None
        })
        return _obj
