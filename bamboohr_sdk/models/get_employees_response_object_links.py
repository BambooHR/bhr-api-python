...
class GetEmployeesResponseObjectLinks(BaseModel):
    """
    Navigation links for API pagination
    """ # noqa: E501
    var_self: Optional[GetEmployeesResponseObjectLinksSelf] = Field(default=None, alias="self")
    next: Optional[GetEmployeesResponseObjectLinksNext] = None
    prev: Optional[GetEmployeesResponseObjectLinksPrev] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "self": GetEmployeesResponseObjectLinksSelf.from_dict(obj["self"]) if obj.get("self") is not None else None,
            "next": GetEmployeesResponseObjectLinksNext.from_dict(obj["next"]) if obj.get("next") is not None else None,
            "prev": GetEmployeesResponseObjectLinksPrev.from_dict(obj["prev"]) if obj.get("prev") is not None else None
        })
        return _obj
