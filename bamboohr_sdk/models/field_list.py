...
class FieldList(BaseModel):
    ...
    FieldList
    """ # noqa: E501
    fields: Optional[List[FieldListFieldsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fields": [FieldListFieldsInner.from_dict(_item) for _item in obj["fields"]] if obj.get("fields") is not None else None
        })
        return _obj
