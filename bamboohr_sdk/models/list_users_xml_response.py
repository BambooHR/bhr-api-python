...
class ListUsersXmlResponse(BaseModel):
    """
    ListUsersXmlResponse
    """ # noqa: E501
    user: Optional[List[ListUsersXmlResponseUserInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "user": [ListUsersXmlResponseUserInner.from_dict(_item) for _item in obj["user"]] if obj.get("user") is not None else None
        })
        return _obj
