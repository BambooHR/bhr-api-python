...
class GetEmployeesEmployeeResponse(BaseModel):
    ...
    first_name: StrictStr | None = Field(description="Employee's first name", alias="firstName")
    last_name: StrictStr | None = Field(description="Employee's last name", alias="lastName")
    preferred_name: StrictStr | None = Field(description="Employee's preferred name", alias="preferredName")
    photo_url: StrictStr | None = Field(description="URL to employee's profile photo", alias="photoUrl")
    job_title_name: StrictStr | None = Field(description="Employee's current job title", alias="jobTitleName")
    status: StrictStr | None = Field(description="Employee's current status (active/inactive)")
    ...
    best_email: StrictStr | None = Field(
        default=None,
