...
class ApplicationsList(BaseModel):
    ...
    next_page_url: StrictStr | None = Field(default=None, alias="nextPageUrl")
    applications: list[ApplicationsListApplicationsInner] | None = Field(
        default=None, description="List of application objects"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "applications": [ApplicationsListApplicationsInner.from_dict(_item) for _item in obj["applications"]]
