...
class UpdateApplicantStatusRequest(BaseModel):
    ...
    """ # noqa: E501
    status: StrictInt = Field(description="The ID of the status to assign to the application. Use the Get Applicant Statuses endpoint to get available status IDs.")
