...
class ListFieldValues(BaseModel):
    ...
    options: list[ListFieldValuesOptionsInner] | None = Field(
        default=None, description="The list field options to create, update, or archive."
    )
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "options": [ListFieldValuesOptionsInner.from_dict(_item) for _item in obj["options"]]
