...
class ListFieldValues(BaseModel):
    """
    Payload for creating, updating, or archiving options on a list field.
    """ # noqa: E501
    options: Optional[List[ListFieldValuesOptionsInner]] = Field(default=None, description="The list field options to create, update, or archive.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "options": [ListFieldValuesOptionsInner.from_dict(_item) for _item in obj["options"]] if obj.get("options") is not None else None
        })
        return _obj
