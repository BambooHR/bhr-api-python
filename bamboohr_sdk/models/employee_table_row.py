...
class EmployeeTableRow(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The table row ID.")
    employee_id: Optional[StrictStr] = Field(default=None, description="The employee ID that owns this row.", alias="employeeId")
