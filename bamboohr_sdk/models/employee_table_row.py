...
class EmployeeTableRow(BaseModel):
    ...
    id: StrictStr | None = Field(default=None, description="The table row ID.")
    employee_id: StrictStr | None = Field(
        default=None, description="The employee ID that owns this row.", alias="employeeId"
    )
    additional_properties: dict[str, Any] = {}
    __properties: ClassVar[list[str]] = ["id", "employeeId"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({"id": obj.get("id"), "employeeId": obj.get("employeeId")})
