...
class EmployeesDirectoryXmlResponseEmployeesEmployeeInnerFieldInner(BaseModel):
    """
    EmployeesDirectoryXmlResponseEmployeesEmployeeInnerFieldInner
    """

    id: StrictStr | None = Field(default=None, description="Field identifier matching one of the ids in `<fieldset>`.")
    value: StrictStr | None = Field(default=None, description="Field value serialized as element text content.")
