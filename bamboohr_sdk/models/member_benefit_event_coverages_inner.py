...
class MemberBenefitEventCoveragesInner(BaseModel):
    ...
    plan_id: StrictStr | None = Field(default=None, description="The ID of the benefit plan.", alias="planId")
    events: list[MemberBenefitEventCoveragesInnerEventsInner] | None = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "events": [MemberBenefitEventCoveragesInnerEventsInner.from_dict(_item) for _item in obj["events"]]
