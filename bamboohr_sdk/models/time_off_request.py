...
class TimeOffRequest(BaseModel):
    ...
    time_off_type_id: StrictInt = Field(
        description="The ID of the time off type for this request.", alias="timeOffTypeId"
    )
    ...
    previous_request: StrictInt | None = Field(
        default=None,
        description="The ID of a previous time off request to supersede. The previous request will be cancelled.",
        alias="previousRequest",
    )
    notes: list[TimeOffRequestNotesInner] | None = Field(
        default=None, description="Optional notes from the employee or manager."
    )
    dates: list[TimeOffRequestDatesInner] | None = Field(
        default=None,
