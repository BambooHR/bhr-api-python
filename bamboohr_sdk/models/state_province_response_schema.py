...
class StateProvinceResponseSchema(BaseModel):
    ...
    """ # noqa: E501
    options: Optional[List[StateProvinceSchema]] = Field(default=None, description="Array of state/province options")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "options": [StateProvinceSchema.from_dict(_item) for _item in obj["options"]] if obj.get("options") is not None else None
        })
        return _obj
