...
class ClockEntriesSchema(BaseModel):
    """
    Request body schema for operations involving multiple clock entries
    """ # noqa: E501
    entries: Annotated[List[ClockEntrySchema], Field(min_length=1)] = Field(description="Array of clock entries")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [ClockEntrySchema.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None
        })
        return _obj
