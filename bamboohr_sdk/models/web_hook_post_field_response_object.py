...
class WebHookPostFieldResponseObject(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fields": [WebHookPostFieldDataObject.from_dict(_item) for _item in obj["fields"]] if obj.get("fields") is not None else None,
            "pages": [WebHookPostFieldPageDataObject.from_dict(_item) for _item in obj["pages"]] if obj.get("pages") is not None else None,
            "tables": [WebHookPostFieldTableDataObject.from_dict(_item) for _item in obj["tables"]] if obj.get("tables") is not None else None
        })
        return _obj
