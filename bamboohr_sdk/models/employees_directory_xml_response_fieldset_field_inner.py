...
class EmployeesDirectoryXmlResponseFieldsetFieldInner(BaseModel):
    """
    ...
    id: StrictStr | None = Field(
        default=None,
        description="Field identifier; matches the `id` attribute on each `<field>` element inside `<employee>`.",
    )
    value: StrictStr | None = Field(
        default=None, description="Human-readable field label, serialized as the element's text content."
    )
