...
class TimeOffTypesAndDefaultHoursDefaultHoursInner(BaseModel):
    """
    TimeOffTypesAndDefaultHoursDefaultHoursInner
    """

    name: StrictStr = Field(description="Day of week")
    amount: StrictStr = Field(description="Default hours for the day. Returned as a stringified decimal value.")
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({"name": obj.get("name"), "amount": obj.get("amount")})
        return _obj
