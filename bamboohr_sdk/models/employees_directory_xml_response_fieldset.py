...
class EmployeesDirectoryXmlResponseFieldset(BaseModel):
    """
    Field definitions included in this response.
    """

    var_field: list[EmployeesDirectoryXmlResponseFieldsetFieldInner] | None = Field(default=None, alias="field")
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "field": [EmployeesDirectoryXmlResponseFieldsetFieldInner.from_dict(_item) for _item in obj["field"]]
