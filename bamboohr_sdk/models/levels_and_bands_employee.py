...
class LevelsAndBandsEmployee(BaseModel):
    """
    Job titles employee object
    """

    id: StrictInt | None = Field(default=None, description="Employee id")
    name: StrictStr | None = Field(default=None, description="Employee name")
