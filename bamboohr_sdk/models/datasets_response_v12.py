...
class DatasetsResponseV12(BaseModel):
    """
    DatasetsResponseV12
    """

    datasets: list[DatasetsResponseV12DatasetsInner] | None = Field(
        default=None, description="Array of available datasets"
    )
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "datasets": [DatasetsResponseV12DatasetsInner.from_dict(_item) for _item in obj["datasets"]]
