...
EMPLOYEEVALUEANYOFINNER_ANY_OF_SCHEMAS = ["bool", "float", "int", "object", "str"]
...
class EmployeeValueAnyOfInner(BaseModel):
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in EmployeeValueAnyOfInner with anyOf schemas: bool, float, int, object, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into EmployeeValueAnyOfInner with anyOf schemas: bool, float, int, object, str. Details: " + ", ".join(error_messages))
        else:
            return instance
