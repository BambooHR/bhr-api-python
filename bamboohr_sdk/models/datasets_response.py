...
class DatasetsResponse(BaseModel):
    ...
    DatasetsResponse
    """ # noqa: E501
    datasets: Optional[List[DatasetsResponseDatasetsInner]] = Field(default=None, description="Array of available datasets")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "datasets": [DatasetsResponseDatasetsInner.from_dict(_item) for _item in obj["datasets"]] if obj.get("datasets") is not None else None
        })
        return _obj
