...
class EmployeeResponse(BaseModel):
    ...
    aggregations: list[EmployeeResponseAggregationsInner] | None = None
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "data": obj.get("data"),
                "aggregations": [EmployeeResponseAggregationsInner.from_dict(_item) for _item in obj["aggregations"]]
