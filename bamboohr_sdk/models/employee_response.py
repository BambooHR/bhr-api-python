...
class EmployeeResponse(BaseModel):
    ...
    aggregations: Optional[List[EmployeeResponseAggregationsInner]] = None
    pagination: Optional[Pagination] = None
    __properties: ClassVar[List[str]] = ["data", "aggregations", "pagination"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": obj.get("data"),
            "aggregations": [EmployeeResponseAggregationsInner.from_dict(_item) for _item in obj["aggregations"]] if obj.get("aggregations") is not None else None,
