...
from bamboohr_sdk.api_response import T as ApiResponseT
...
class ApiClient:
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None, cookie=None) -> None:
        ...
        self.cookie = cookie
        # BambooHR SDK: Set custom User-Agent identifying the SDK
    ...
    def call_api(
        ...
        """Makes the HTTP request with retry support.

        BambooHR SDK: Wraps the HTTP request with application-level retry logic
        using exponential backoff for retryable status codes.
        ...
        response_data = send_with_retries(
            ...
            url=url,
            headers=header_params,
            max_retries=self.configuration.retries,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(bamboohr_sdk.models, klass)
