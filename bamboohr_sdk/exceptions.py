...
class ApiException(OpenApiException):
    ...
    def __str__(self):
        ...
        if self.request_id:
            error_message += f"Request ID: {self.request_id}\n"
