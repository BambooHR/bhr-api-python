...
class CustomReportsApi:
    ...
    def get_by_report_id(
        self,
        report_id: Annotated[StrictInt, Field(description="The ID of the saved custom report to retrieve data for.")],
        ...
        :param report_id: The ID of the saved custom report to retrieve data for. (required)
        :type report_id: int
