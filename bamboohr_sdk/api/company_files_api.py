...
class CompanyFilesApi:
    ...
    @validate_call
    def create_company_file_category(
        self,
        ...
        _param = self._create_company_file_category_serialize(
    ...
    @validate_call
    def create_company_file_category_with_http_info(
        self,
        request_body: list[StrictStr],
        _request_timeout: None
        | Annotated[StrictFloat, Field(gt=0)]
    ...
    @validate_call
    def create_company_file_category_without_preload_content(
        self,
        request_body: list[StrictStr],
        _request_timeout: None
        | Annotated[StrictFloat, Field(gt=0)]
    ...
    def _create_company_file_category_serialize(
        self,
        request_body,
        _request_auth,
        _content_type,
    ...
    def delete_company_file(
        self,
        file_id: Annotated[StrictInt | None, Field(description="The ID of the company file to delete.")],
        _request_timeout: None
        | Annotated[StrictFloat, Field(gt=0)]
        | tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]] = None,
        _request_auth: dict[StrictStr, Any] | None = None,
    ...
    def get_company_file(
        self,
        file_id: Annotated[StrictInt | None, Field(description="The ID of the company file to download.")],
        _request_timeout: None
        | Annotated[StrictFloat, Field(gt=0)]
        | tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]] = None,
        _request_auth: dict[StrictStr, Any] | None = None,
    ...
    def update_company_file(
        self,
        file_id: Annotated[StrictInt | None, Field(description="The ID of the company file to update.")],
    ...
    def upload_company_file(
        ...
        category: Annotated[
            StrictInt, Field(description="The ID of the file category (section) to upload the file into.")
        ],
        file: Annotated[
