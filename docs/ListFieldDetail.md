...
------------ | ------------- | ------------- | -------------
**id** | **int** | The list ID. | [optional] 
**field_id** | **int** | The field ID. | [optional] 
**name** | **str** | The display name of the list field. | [optional] 
**alias** | **str** |  | [optional] 
**manageable** | **str** | Whether the list field options can be modified via the API. | [optional] 
**multiple** | **str** | Whether this field supports multiple values. | [optional] 
