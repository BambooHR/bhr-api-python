...
**allowable_benefit_types** | **List[Optional[str]]** | Benefit plan types this sub-type applies to. | [optional] 
...
**managed_deduction_type** | **str** |  | [optional] 
**sub_types** | **List[Optional[object]]** | Always an empty array for sub-types. | [optional] 
