...
time_tracking_create_time_tracking_break_v1_instance = TimeTrackingCreateTimeTrackingBreakV1.from_json(json)
# print the JSON string representation of the object
print(TimeTrackingCreateTimeTrackingBreakV1.to_json())

# convert the object into a dict
time_tracking_create_time_tracking_break_v1_dict = time_tracking_create_time_tracking_break_v1_instance.to_dict()
# create an instance of TimeTrackingCreateTimeTrackingBreakV1 from a dict
time_tracking_create_time_tracking_break_v1_from_dict = TimeTrackingCreateTimeTrackingBreakV1.from_dict(time_tracking_create_time_tracking_break_v1_dict)
```
