...
**last_update_date_time** | **str** | The date and time in which the goal was last updated. | [optional] 
...
transformed_api_goal_milestones_inner_instance = TransformedApiGoalMilestonesInner.from_json(json)
# print the JSON string representation of the object
print(TransformedApiGoalMilestonesInner.to_json())

# convert the object into a dict
transformed_api_goal_milestones_inner_dict = transformed_api_goal_milestones_inner_instance.to_dict()
# create an instance of TransformedApiGoalMilestonesInner from a dict
transformed_api_goal_milestones_inner_from_dict = TransformedApiGoalMilestonesInner.from_dict(transformed_api_goal_milestones_inner_dict)
```
